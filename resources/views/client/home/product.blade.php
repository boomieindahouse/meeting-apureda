<section class="grid grid-cols-3">
    ...
    <div class="relative bg-gray-100 shadow-lg overflow-hidden h-[900px]">
        ...
        <img src="{{ asset('images/homepage/product/prod1.png') }}" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-auto h-auto object-cover">
    ...
    <div class="relative bg-gray-100 shadow-lg overflow-hidden h-[900px]">
        <img src="{{ asset('images/homepage/product/productbg1.png') }}" class="w-full h-[900px] object-cover opacity-20">
        <img src="{{ asset('images/homepage/product/prod2.png') }}" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-auto h-auto object-cover">
        <div class="absolute bottom-0 bg-gradient-to-t from-black to-transparent w-full p-10 text-white">
